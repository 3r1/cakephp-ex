...
$cakeDescription = '3r1-api on CakePHP: the rapid development PHP framework';
?>
<!DOCTYPE html>
<html>
<head>
...
<header class="row">
    ...
    <div class="header-title">
        <h1>Welcome to 3r1-api on CakePHP <?= Configure::version() ?> Red Velvet. Build fast. Grow solid.</h1>
    </div>
</header>
...
<div class="row">
    ...
    <div class="columns large-4">
        <i class="icon training">C</i>
        <h3>Training and Such</h3>
        <ul>
            <li class="bullet cutlery">
